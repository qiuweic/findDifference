...
public class GameInfo {
    ...
    static { // Left,Top, Right, Bottom
        ...
        GAME_LEVEL_COORDINATE.put(1, new int[][]{{2, 422, 105, 525}, {303, 20, 380, 100}, {345, 369, 450, 505}, {465, 143, 562, 262}, {600, 45, 700, 144}});
        GAME_LEVEL_COORDINATE.put(2, new int[][]{{23, 135, 105, 280}, {50, 286, 162, 384}, {361, 32, 479, 169}, {452, 283, 545, 434}, {592, 2, 687, 84}});
        GAME_LEVEL_COORDINATE.put(3, new int[][]{{57, 279, 180, 397}, {200, 287, 290, 400}, {330, 420, 435, 500}, {523, 110, 630, 180}, {565, 190, 650, 270}});
        GAME_LEVEL_COORDINATE.put(4, new int[][]{{53, 180, 214, 300}, {163, 13, 297, 110}, {267, 370, 325, 470}, {330, 320, 400, 440}, {340, 150, 440, 280}});
        GAME_LEVEL_COORDINATE.put(5, new int[][]{{125, 170, 220, 270}, {130, 290, 220, 400}, {362, 162, 450, 265}, {525, 210, 600, 300}, {558, 80, 700, 200}});
        ...
        GAME_LEVEL_COORDINATE.put(8, new int[][]{{70, 365, 257, 508}, {220, 110, 329, 280}, {440, 160, 510, 280}, {515, 170, 685, 280}, {610, 80, 690, 170}});
        ...
        GAME_LEVEL_COORDINATE.put(71, new int[][]{{22, 298, 109, 382}, {395, 249, 477, 331}, {602, 274, 671, 413}, {475, 360, 578, 454}, {96, 454, 173, 527}});
        GAME_LEVEL_COORDINATE.put(72, new int[][]{{6, 154, 97, 277}, {382, 35, 481, 210}, {497, 143, 588, 247}, {556, 316, 648, 429}, {109, 330, 265, 462}});
        GAME_LEVEL_COORDINATE.put(73, new int[][]{{74, 131, 166, 255}, {521, 13, 596, 103}, {479, 168, 583, 278}, {565, 410, 665, 507}, {46, 440, 144, 525}});
        GAME_LEVEL_COORDINATE.put(74, new int[][]{{16, 289, 122, 378}, {362, 169, 535, 249}, {409, 350, 533, 496}, {343, 471, 543, 529}, {610, 475, 683, 524}});
        GAME_LEVEL_COORDINATE.put(75, new int[][]{{4, 246, 96, 352}, {258, 104, 329, 203}, {364, 53, 512, 145}, {611, 127, 699, 232}, {324, 373, 435, 494}});
        GAME_LEVEL_COORDINATE.put(76, new int[][]{{124, 227, 220, 321}, {271, 152, 341, 233}, {329, 222, 422, 331}, {568, 99, 639, 184}, {574, 295, 646, 361}});
        GAME_LEVEL_COORDINATE.put(77, new int[][]{{13, 390, 133, 474}, {172, 172, 237, 258}, {368, 263, 450, 355}, {465, 136, 534, 213}, {653, 301, 701, 406}});
        GAME_LEVEL_COORDINATE.put(78, new int[][]{{184, 164, 258, 242}, {178, 307, 254, 397}, {308, 440, 483, 523}, {409, 178, 496, 292}, {535, 262, 621, 398}});
        GAME_LEVEL_COORDINATE.put(79, new int[][]{{88, 6, 239, 102}, {358, 49, 446, 169}, {430, 200, 549, 331}, {328, 140, 415, 239}, {87, 276, 198, 443}});
